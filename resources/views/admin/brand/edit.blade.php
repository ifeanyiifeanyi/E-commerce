                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Recommended size: 300x200 pixels. Max file size:
                                            2MB</small>
                                        <img src="{{ asset('storage/' . $brand->logo) }}" id="logoPreview"
                                            class="logo-preview img-thumbnail" width="300" height="200" alt="Logo preview">
                                        @error('logo')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 form-group">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="status"
                                                name="status" value="1" {{ old('status', $brand->status) ? 'checked' : '' }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <textarea name="meta_description" id="meta_description"
                                            class="form-control @error('meta_description') is-invalid @enderror" rows="2">{{ old('meta_description', $brand->meta_description) }}</textarea>
