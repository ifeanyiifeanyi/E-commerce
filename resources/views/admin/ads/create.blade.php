...
@section('title', 'Create Advertisement Package')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Advertisement Package</h3>
                ...
                <form action="{{ route('admin.advertisement.packages.store') }}" method="POST" id="packageForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Basic Information -->
