    ...
    <div class="container-fluid">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ number_format($stats['total_advertisements']) }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ number_format($stats['pending_approval']) }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ number_format($stats['active_advertisements']) }}</div>
                            </div>
                            <div class="col-auto">
        ...
        @if ($stats['expiring_soon'] > 0)
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <a href="{{ route('admin.vendor.advertisements', ['status' => 'active']) }}" class="alert-link">View
                    them</a>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow">
                        <a class="dropdown-item" href="{{ route('admin.vendor.advertisements', ['status' => 'pending']) }}">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="search" class="form-control"
                                placeholder="Search by title or vendor..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-2">
                    ...
                    <table class="table table-hover table-striped w-100" id="datatables">
                        ...
                        <tbody>
                            @forelse($advertisements as $advertisement)
                                <tr>
                                    <td>
                                        <input type="checkbox" name="advertisement_ids[]"
                                            value="{{ $advertisement->id }}"
                                            class="form-check-input advertisement-checkbox">
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            @if ($advertisement->image_url)
                                                <img src="{{ $advertisement->image_url }}" alt="Ad Image"
                                                    class="rounded me-2"
                                    ...
                                    <td>
                                        <span class="badge bg-info">{{ $advertisement->package->name }}</span>
                                        <br>
                                        <small class="text-muted">{{ $advertisement->package->duration_days }}
                                            days</small>
                                    </td>
                                    <td>
                                        @php
                                        ...
                                        @endphp
                                        <span
                                            class="badge {{ $statusClass }}">{{ ucfirst($advertisement->status) }}</span>
                                        @if (
                                            $advertisement->expires_at &&
                                                $advertisement->expires_at <= now()->addDays(7) &&
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $paymentClass =
                                                $paymentStatusClasses[$advertisement->payment_status] ?? 'bg-secondary';
                                        @endphp
                                        <span
                                            class="badge {{ $paymentClass }}">{{ ucfirst($advertisement->payment_status) }}</span>
                                    </td>
                                    <td>
                                        <strong>₦{{ number_format($advertisement->amount_paid, 2) }}</strong>
                                    </td>
                                    <td>
                                        <small>{{ $advertisement->created_at->format('M d, Y') }}</small>
                                        <br>
                                        <small
                                            class="text-muted">{{ $advertisement->created_at->format('H:i A') }}</small>
                                    </td>
                                    <td>
                                        @if ($advertisement->expires_at)
                                            ...
                                            <br>
                                            <small
                                                class="text-muted">{{ $advertisement->expires_at->diffForHumans() }}</small>
                                        @else
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.vendor.advertisements.show', $advertisement) }}"
                                            ...
                                            @if ($advertisement->status === 'pending' && $advertisement->payment_status === 'completed')
                                                <button class="btn btn-sm btn-outline-success"
                                                    onclick="showApprovalModal({{ $advertisement->id }})"
                                                    title="Approve">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger"
                                                    onclick="showRejectionModal({{ $advertisement->id }})"
                                                    title="Reject">
                                            ...
                                            @if ($advertisement->status === 'active')
                                                <button class="btn btn-sm btn-outline-warning"
                                                    onclick="showSuspensionModal({{ $advertisement->id }})"
                                                    title="Suspend">
                                            ...
                                            @if ($advertisement->status === 'paused')
                                                <form method="POST"
                                                    action="{{ route('admin.vendor.advertisements.reactivate', $advertisement) }}"
                                                    class="d-inline">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-outline-success"
                                                        title="Reactivate"
                                                        onclick="return confirm('Reactivate this advertisement?')">
                                            ...
                                            <button class="btn btn-sm btn-outline-primary"
                                                onclick="showMessageModal({{ $advertisement->id }})"
                                                title="Send Message">
                                                <i class="fas fa-envelope"></i>
                                            </button>
                                            @if ($advertisement->canBeDeleted())
                                                <button class="btn btn-sm btn-outline-danger"
                                                    onclick="confirmDelete({{ $advertisement->id }}, '{{ addslashes($advertisement->title) }}')"
                                                    title="Delete">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div>
                        Showing {{ $advertisements->firstItem() ?? 0 }} to {{ $advertisements->lastItem() ?? 0 }} of
                        {{ $advertisements->total() }} results
                    </div>
                ...
                <form id="approvalForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message_to_vendor" class="form-control" rows="3"
                                placeholder="Send a personalized message to the vendor..."></textarea>
                        </div>
                    </div>
                ...
                <form id="rejectionForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning">
                            ...
                            <strong>Warning:</strong> Rejecting this advertisement will automatically process a refund if
                            payment was completed.
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Rejection Reason <span class="text-danger">*</span></label>
                            <textarea name="rejection_reason" class="form-control" rows="3"
                                placeholder="Explain why this advertisement is being rejected..." required></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Message to Vendor (Optional)</label>
                            <textarea name="message_to_vendor" class="form-control" rows="3"
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <textarea name="suspension_reason" class="form-control" rows="3"
                                placeholder="Explain why this advertisement is being suspended..." required></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Message to Vendor (Optional)</label>
                            <textarea name="message_to_vendor" class="form-control" rows="3"
                ...
                <form id="messageForm" method="GET">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <textarea name="message" class="form-control" rows="4" placeholder="Type your message to the vendor..."
                                required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="bulkActionForm" method="POST"
                    action="{{ route('admin.vendor.advertisements.bulk-action') }}">
                    @csrf
                    <div class="modal-header">
...
@section('js')
    <script>
        ...
        function updateBulkActionButton() {
            ...
            if (checkedBoxes.length > 0) {
                selectedCount.innerHTML =
                    `<i class="fas fa-check-circle"></i> ${checkedBoxes.length} advertisement(s) selected.`;
        ...
        function confirmDelete(advertisementId, title) {
            Swal.fire({
                title: 'Are you sure?',
                html: `You want to delete the advertisement: <br><strong>"${title}"</strong>`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = 'POST';
                    form.action = `/admin/vendor-advertisements/${advertisementId}`;
