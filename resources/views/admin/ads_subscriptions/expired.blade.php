...
@section('title', 'Suspended Advertisement Management')

@section('breadcrumb-parent', 'Advertisement Management')
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <!-- Filters -->
        <div class="card-body">
            <form method="GET" action="{{ route('admin.vendor.advertisements.suspended_details') }}" class="mb-4">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    @if($advertisement->status === 'paused')
                                        <button class="btn btn-sm btn-outline-success" onclick="showReactivateModal({{ $advertisement->id }})" title="Reactivate">
                                    ...
                                    @if($advertisement->canBeDeleted())
                                        <button class="btn btn-sm btn-outline-danger" onclick="confirmDelete({{ $advertisement->id }}, '{{ addslashes($advertisement->title) }}')" title="Delete">
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    <p>No suspended advertisements found.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="modal-content">
            <form id="reactivateForm" method="POST">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Reactivate Advertisement</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i>
                        <strong>Info:</strong> Reactivating this advertisement will make it active again until its expiration date.
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Message to Vendor (Optional)</label>
                        <textarea name="message_to_vendor" class="form-control" rows="3" placeholder="Send a message to the vendor about reactivating their advertisement..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-play"></i> Reactivate Advertisement
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    // New Reactivate Modal Function
    function showReactivateModal(advertisementId) {
        const form = document.getElementById('reactivateForm');
        form.action = `/admin/vendor-advertisements/${advertisementId}/reactivate`;
