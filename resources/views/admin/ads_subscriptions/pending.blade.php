...
@section('title', 'Pending Advertisement Management')

@section('breadcrumb-parent', 'All Adverts')
                    ...
                    <table class="table table-hover table-striped w-100" id="datatables">
                        ...
                        <tbody>
                            @forelse($advertisements as $advertisement)
                                <tr>
                                    <td>
                                        <input type="checkbox" name="advertisement_ids[]" value="{{ $advertisement->id }}"
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            @if ($advertisement->status === 'pending' && $advertisement->payment_status === 'completed')
                                                <button class="btn btn-sm btn-outline-success"
                                                    onclick="showApprovalModal({{ $advertisement->id }})" title="Approve">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-danger"
                                                    onclick="showRejectionModal({{ $advertisement->id }})" title="Reject">
                                            ...
                                            <button class="btn btn-sm btn-outline-primary"
                                                onclick="showMessageModal({{ $advertisement->id }})" title="Send Message">
...
@section('js')
    <script>
        ...
        function showSuspensionModal(advertisementId) {
            ...
            form.action = `/admin/advertisements/${advertisementId}/suspend`;
