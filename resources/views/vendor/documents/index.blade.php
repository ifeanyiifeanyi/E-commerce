                ...
                <div class="card-body">
                    ...
                    @if($documents->isEmpty())
                        <div class="alert alert-info">
                            <p>You haven't uploaded any verification documents yet. Please upload the necessary documents to complete your vendor verification.</p>
                        </div>
                    @else
                                ...
                                <tbody>
                                    @foreach($documents as $document)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @if($document->rejection_reason)
                                                        <i class="fas fa-info-circle" data-toggle="tooltip" title="{{ $document->rejection_reason }}"></i>
                                                    @endif
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('vendor.documents.show', $document) }}" class="btn btn-sm btn-info">
