                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    @php
                                        $extension = pathinfo(storage_path('app/' . $document->file_path), PATHINFO_EXTENSION);
                                    @endphp

                                    @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png']))
                                        <img src="{{ Storage::url($document->file_path) }}" alt="Document" class="img-fluid">
                                    @elseif(strtolower($extension) === 'pdf')
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" src="{{ asset($document->file_path) }}" allowfullscreen></iframe>
                                        </div>
                                    @else
                                ...
                                <div class="card-footer">
                                    <a href="{{ Storage::url($document->file_path) }}" class="btn btn-primary btn-block" target="_blank">
                    ...
                    <div class="mt-4">
                        ...
                        @if($document->status != 'approved')
                            <form action="{{ route('vendor.documents.destroy', $document) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
