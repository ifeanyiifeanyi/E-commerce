...
@section('vendor')
    <div class="container-fluid">
        ...
        <form id="productForm" method="POST" action="{{ route('vendor.products.update', $product->id) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="product_qty" name="product_qty"
                                            min="0" step="any"
                                            value="{{ old('product_qty', $product->product_qty) }}" required>
                                        @error('product_qty')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="editor-container">
                                    <div id="long_description_editor" style="height: 300px;">{!! old('long_description', $product->long_description) !!}</div>
                                        ...
                                        <select class="form-select select2" id="measurement_unit_id"
                                            ...
                                            @foreach ($measurementUnits as $unit)
                                                <option value="{{ $unit->id }}"
                                                    {{ old('measurement_unit_id', $product->measurement_unit_id) == $unit->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="base_unit" name="base_unit"
                                            value="{{ old('base_unit', $product->base_unit) }}">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                ...
                                                {{ old('is_weight_based', $product->is_weight_based) ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                ...
                                                {{ old('allow_decimal_qty', $product->allow_decimal_qty) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                id="track_inventory" name="track_inventory"
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                ...
                                                {{ old('allow_backorders', $product->allow_backorders) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                id="enable_stock_alerts" name="enable_stock_alerts"
                                                {{ old('enable_stock_alerts', $product->enable_stock_alerts) ? 'checked' : '' }}>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" value="1" id="featured"
                                    name="featured" {{ old('featured', $product->featured) ? 'checked' : '' }}>
                                <label class="form-check-label" for="featured">Featured Product</label>
                            </div>

                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" value="1" id="hot_deals"
                                    name="hot_deals" {{ old('hot_deals', $product->hot_deals) ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" value="1" id="special_offer"
                                    name="special_offer"
                                    {{ old('special_offer', $product->special_offer) ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" value="1" id="special_deals"
                                    name="special_deals"
                                    {{ old('special_deals', $product->special_deals) ? 'checked' : '' }}>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="product_thumbnail" class="form-label">Main Image</label>
                                <input type="file" class="form-control" id="product_thumbnail"
                                    name="product_thumbnail" accept="image/*">
                            ...
                            <div class="mb-3">
                                <div class="thumbnail-preview mt-2">
                                    <img id="thumbnail_preview"
                                        src="{{ $product->product_thumbnail ? asset('uploads/products/thumbnails/' . $product->product_thumbnail) : asset('') }}"
                                        alt="Thumbnail Preview" class="img-fluid img-thumbnail">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="position-relative">
                                            <img src="{{ asset('uploads/products/multi-images/' . $image->photo_name) }}"
                                                class="img-fluid img-thumbnail" alt="Gallery Image">
                                            <a href="{{ route('vendor.products.delete-multi-image', $image->id) }}"
