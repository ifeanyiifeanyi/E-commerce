...
class ProductService
{
    ...
    public function createProduct(array $data, array $files)
    {
        ...
        // Prepare inventory management data
    ...
    /**
     * Prepare inventory management data from request
     */
    private function prepareInventoryData(array $data)
    {
        return [
            'track_inventory' => isset($data['track_inventory']) && $data['track_inventory'] ? true : false,
            'allow_backorders' => isset($data['allow_backorders']) && $data['allow_backorders'] ? true : false,
            'low_stock_threshold' => $data['low_stock_threshold'] ?? null,
            'enable_stock_alerts' => isset($data['enable_stock_alerts']) && $data['enable_stock_alerts'] ? true : false,
        ];
    }
